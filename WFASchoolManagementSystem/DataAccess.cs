...
namespace WFASchoolManagementSystem
{
    class DataAccess
    {
        ...
        public DataAccess()
        {
            this.Sqlcon = new SqlConnection(@"Data Source=DESKTOP-C5Q1FFJ;Initial Catalog=SchoolManagementSystemVer11;Persist Security Info=True;User ID=sa;Password=blu3@TOp");
            Sqlcon.Open();
        }
